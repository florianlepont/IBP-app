...
last_activity_desc: Code audit remediation inserted as Phases 1.2–1.5; Phase 6 re-scoped after re-checking the SQL and index concerns
progress:
  total_phases: 12
  completed_phases: 0
  total_plans: 6
...
Phase: 1 of 12 (Species Recognition — Approach Decision)
Plan: 0 of 6 in current phase
Status: Ready to plan
Last activity: 2026-09-23 — code audit remediation inserted as Phases 1.2–1.5; Phase 6 re-scoped
...
- Phases 01.2–01.5 inserted after Phase 1 from the 2026-09 code audit (URGENT): stop field data loss and account exposure; CI and test safety net; API sync integrity; mobile sync engine reliability. Phase 7 now depends on 1.2, 1.4 and 1.5. The remaining audit lots are deferred to the next milestone (REQUIREMENTS.md → Deferred — Next Milestone (Code Audit Remainder))
...
| Code audit | Lots L7 (rest), L10, L13–L20 — architecture, performance, i18n, hygiene | Deferred to next milestone | 2026-09-23 |
