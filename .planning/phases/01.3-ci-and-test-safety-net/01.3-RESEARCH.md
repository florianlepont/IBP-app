...
1. **Should `useSurveySync.test.ts` be rewritten to `renderHook` in this phase, or deferred?**
...
2. **Fix `expo-doctor`'s two findings, or suppress them?**
