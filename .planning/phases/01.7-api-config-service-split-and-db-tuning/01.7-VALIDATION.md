...
**Approval:** approved 2026-09-26: deployed; owner VPS sitting done; production probes green. The centroid NULL-count check on production is still to be run by the owner.
