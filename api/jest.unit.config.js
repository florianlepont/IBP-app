...
module.exports = {
  ...
  // Ratchet (phase 01.3, D-09; raised in phase 01.4): floor of values measured on 2026-09-24. Raise these when
  ...
  coverageThreshold: {
    ...
    './src/surveys/': { statements: 46, branches: 33, functions: 35, lines: 46 },
