import { Body, Controller, Delete, Get, HttpCode, Patch, Post, Put, Res, StreamableFile, UploadedFile, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class UsersController {
  ...
  @HttpCode(200)
  confirmEmailChange(@CurrentUser() user: AuthenticatedUser, @Body() body: { token?: string }) {
