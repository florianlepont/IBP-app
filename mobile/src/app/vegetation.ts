...
export const VEGETATION_STAGE_OPTIONS_BY_REGION: Record<RegionVersion, Array<{ value: VegetationStage; label: string }>> = {
  ACA: [
...
export const normalizeVegetationStageForRegion = (region: RegionVersion, stage: unknown): VegetationStage => {
