...
jest.mock('react-native', () => {
  ...
  return {
    Button: ({ children, ...props }: { children?: React.ReactNode }) => ReactRef.createElement('Button', props, children),
...
const buildProps = (overrides?: Partial<ComponentProps<typeof ProfileScreen>>): ComponentProps<typeof ProfileScreen> => ({
